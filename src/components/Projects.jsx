...
const projects = [
  ...
  {
    title: "Skillion",
    description: "Skillion is a fully responsive Learning Management System built using the MERN stack, designed to deliver seamless experiences for both students and educators It focuses on clean architecture, scalability, and real-world functionality.",
