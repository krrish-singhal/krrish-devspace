import { Github, Linkedin, Twitter, Mail, ExternalLink, Download, Apple as WhatsApp } from 'lucide-react';
import { Link } from 'react-router-dom';

function Footer() {
  const socialLinks = [
    { icon: Github, href: "https://github.com/krrish-singhal", label: "GitHub" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/krrish-singhal-4765b1302/", label: "LinkedIn" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Download my resume to learn more about my experience, skills, and achievements. I'm always open to new opportunities and collaborations.
            </p>
            <a
              href="/resume.pdf"
              download
